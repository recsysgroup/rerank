...
TEST_PATH=/tmp/yahoo_click_test_50.txt
...
java -jar RankLib-2.13.jar -train $TRAIN_PATH -test $TEST_PATH -validate $VALID_PATH -ranker 0 -metric2t MAP -save $MODEL_PATH
...
cat $RERANK_PATH | python evaluator.py 
